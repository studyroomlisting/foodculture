...
-- SEED CATEGORIES
-- ---------------------------------------------------------------------------
insert into categories (name, slug, emoji, description, restaurant_count) values
  ('Biryani',      'biryani',      '🍛', 'Bengaluru''s best biryani spots',            48),
  ('South Indian', 'south-indian', '🥞', 'Authentic dosas, idlis, and filter coffee',  120),
  ('Street Food',  'street-food',  '🧆', 'Chaats, pani puri, and roadside bites',      67),
  ('Burgers',      'burgers',      '🍔', 'Smash burgers and gourmet patties',          22),
  ('Seafood',      'seafood',      '🦀', 'Fresh coastal flavours in the city',          15),
  ('Cafes',        'cafes',        '☕', 'Coffee, brunch, and work-friendly spots',     89),
  ('Fine Dining',  'fine-dining',  '🍷', 'Premium experiences and tasting menus',       18),
  ('Desserts',     'desserts',     '🍨', 'Ice cream, mithai, and sweet treats',         55);

-- SEED LOCATIONS (sub-areas within zones)
insert into locations (zone_id, name, slug, description, restaurant_count) values
  ('11111111-0000-0000-0000-000000000001', 'Koramangala 5th Block', 'koramangala-5th-block', 'The heart of BLR''s food scene', 38),
  ('11111111-0000-0000-0000-000000000001', 'Koramangala 7th Block', 'koramangala-7th-block', 'Buzzing nightlife and restaurants', 24),
  ('11111111-0000-0000-0000-000000000002', 'Indiranagar 12th Main', 'indiranagar-12th-main', 'Pub street and beyond', 31),
  ('11111111-0000-0000-0000-000000000002', 'Indiranagar 100 Feet Road', 'indiranagar-100-feet', 'The main strip', 18),
  ('11111111-0000-0000-0000-000000000003', 'HSR Layout Sector 2',   'hsr-layout-sector-2',   'Quiet neighbourhood gems', 15),
  ('11111111-0000-0000-0000-000000000004', 'JP Nagar 7th Phase',    'jp-nagar-7th-phase',    'Local favourites', 12),
  ('11111111-0000-0000-0000-000000000005', 'Whitefield Main Road',  'whitefield-main-road',  'Tech park crowd favourites', 22);
