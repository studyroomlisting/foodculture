...
-- INFLUENCERS (8)
insert into influencers (id,slug,name,handle,platform,avatar_initials,followers_count,cuisine_tags,bio,impact_score,trust_score,engagement_rate,visits_driven_weekly,connection_fee,rank_this_week) values
...
on conflict (id) do update set rank_this_week=excluded.rank_this_week,impact_score=excluded.impact_score;
...
-- INFLUENCER POSTS
insert into influencer_restaurant_posts (influencer_id, restaurant_id, caption, views, likes, comments, visits_driven, posted_at) values
('66666666-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000001','Tried the Dum Biryani at Dum Biryani House and I am genuinely speechless. 4 hours of slow cooking, whole spices, and the freshest mutton in Bengaluru. The crust on the bottom? Absolutely perfect. Rush there.',420000,38200,1840,340,now() - interval '2 days'),
('66666666-0000-0000-0000-000000000002','22222222-0000-0000-0000-000000000013','Prawn Gassi at Coastal Kitchen BLR is the real deal. Chef sources prawns fresh from Mangalore daily. Neer Dosa pairing is mandatory. This is the coastal Mangalorean cooking Bengaluru has been waiting for.',185000,14600,620,210,now() - interval '4 days'),
('66666666-0000-0000-0000-000000000003','22222222-0000-0000-0000-000000000015','My new weekend ritual: pour-over at Third Wave Coffee BLR. The Ethiopia Yirgacheffe is extraordinary. And the avocado toast with chilli flakes here? Unmissable. Calm, aesthetic, essential.',142000,11200,480,180,now() - interval '1 day'),
('66666666-0000-0000-0000-000000000004','22222222-0000-0000-0000-000000000017','Shot a full documentary on Saffron and Spice. The 7-course Mughal tasting menu is the most ambitious culinary project in Bengaluru. Chef Arjun Dal Makhani is cooked for 72 hours. I have never eaten anything quite like it.',89000,7800,340,145,now() - interval '6 days'),
('66666666-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000011','Street food royalty: Pani Puri Palace 6-flavour shots are genuinely the best pani puri in Bengaluru. The raw mango jaljeera hits different. Queue is long but completely worth it.',96000,9400,560,128,now() - interval '3 days'),
('66666666-0000-0000-0000-000000000006','22222222-0000-0000-0000-000000000020','The Mango Kulfi Waffle Sandwich at Iceberg Desserts is the dessert of the summer. Warm waffle, frozen kulfi, mango compote. 10 out of 10 no notes. Queue is 40 people long on weekends and it is WORTH IT.',78000,8900,720,95,now() - interval '5 days'),
('66666666-0000-0000-0000-000000000007','22222222-0000-0000-0000-000000000012','Bun Intended Truffle Mushroom Burger is in my top 3 Bengaluru burgers ever. The brioche bun is baked in-house daily. Paired with their Wheat Ale it is absolutely exceptional. Go on a weeknight to skip the weekend chaos.',62000,5800,280,84,now() - interval '2 days'),
